<template>
    <div class="echarts oneline-chart-box">
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        drew(obj) {
            ...
            var myonelineChart = echarts.init(document.getElementsByClassName(obj.id)[0]);
            myonelineChart.setOption(obj.option);
            this.$emit('nodeval', myonelineChart);
        },
    }
}
</script>
